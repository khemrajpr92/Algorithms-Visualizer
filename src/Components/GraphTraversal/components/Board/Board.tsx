...
export const Board = () => {
	...
	const [isVisualizing, setVisualizingState] = useState<boolean>(false);
	const [visualizationSpeed, setVisualizationSpeed] = useState<any>(500);
		...
		<>
			<div className={styles.board}>
				...
				>
					...
					<div className={styles.appIcon}>Graph <span style={{color:  '#4039ad', fontWeight: 'bold'}}>Traversals</span></div>
